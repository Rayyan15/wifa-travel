...
<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-800">Edit Data Pemesanan</h2>
        <p class="text-sm text-gray-500 mt-1">Perbarui data transaksi order untuk jamaah.</p>
    </div>
        ...
        <div class="mb-5">
            ...
            <select name="lead_id" id="lead_id"
                ...
                @foreach ($leads as $lead)
                    <option value="{{ $lead->id }}" {{ old('lead_id', $order->lead_id) == $lead->id ? 'selected' : '' }}>
        ...
        <div class="mb-7">
            ...
            <div class="relative">
                ...
                <input type="number" name="total_amount" id="total_amount"
                    value="{{ old('total_amount', intval($order->total_amount)) }}"
